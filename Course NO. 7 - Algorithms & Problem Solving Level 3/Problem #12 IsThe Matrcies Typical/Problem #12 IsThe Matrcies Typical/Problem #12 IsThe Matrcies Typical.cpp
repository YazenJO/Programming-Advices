...
bool isMatrcisTypical(int Matrix1[3][3], int Matrix2[3][3], short Rows, short Clos) {
...
int main()
{
	...
	if (isMatrcisTypical(Matrix1, Matrix2,3,3))
	{
		cout << "\nThe Matrcies is Typical\n";
	}
	else
	{
		cout << "\nThe Matrcies is not Typical\n";
	}
	return 0;
