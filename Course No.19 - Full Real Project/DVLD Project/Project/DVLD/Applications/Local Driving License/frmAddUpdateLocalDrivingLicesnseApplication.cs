...
namespace DVLD.Applications
{
    ...
    public partial class frmAddUpdateLocalDrivingLicesnseApplication: Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (clsLicense.HasIssuedLicenseForSameClass(ctrlPersonCardWithFilter1.PersonID, LicenseClassID))
            {
                MessageBox.Show("Person already Have a License with the same applied driving class " + LicenseClassID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                cbLicenseClass.Focus();
                return;
            }
