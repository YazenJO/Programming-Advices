...
namespace DVLD_DataAccess
{
    public class clsLocalDrivingLicenseApplicationData
    {
        ...
        public static int GetPassedTestCount(int lDLApplicationID)
        {
                int Result = 0;
                SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
                string query = "SELECT ldlav.[Passed Tests] FROM LocalDrivingLicenseApplications_View ldlav WHERE ldlav.[L.D.LAppID]=@lDLApplicationID";
            SqlCommand command = new SqlCommand(query, connection);
        ...
        public static int GetLastFailedTestType(int LocalDrivingLicenseApplicationID, int TestTypeID)
        {
            int Result = 0;
            ...
            string query = @" SELECT  ta.TestAppointmentID
                              ...
                              WHERE (ta.LocalDrivingLicenseApplicationID = @LocalDrivingLicenseApplicationID) AND (ta.TestTypeID = @TestTypeID) AND TestResult=0 ORDER BY ta.TestAppointmentID DESC
";
