...
void ReadNnumberOfArrayElemnts(int NumberOfElemnts, int store[], short& size) {
...
int main()
{
	...
	ReadNnumberOfArrayElemnts(ReadAPositiveNumber("Enter The Number Of elemnts"), store, size);
